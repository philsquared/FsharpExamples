// A few ways to implememnt a Fibonnaci number generator
// The purpose here is to progressively introduce F# syntax
// language fetaures and idioms - starting from a very 
// non-idiomatic imperative version. Each new version
// is not necessarily intended to be better than the
// previous version
// Following each function is a test call that can be run in to the FSI
